...
import { education } from "../reducers/educationReducer";
 ...
 const TemplateBasic_1: React.FC = () => {
        ...
        <div className="flex flex-row border border-gray-300 rounded-sm bg-white shadow-lg">
            ...
            <div className="w-2/3">
                <main className="flex flex-col">
                    ...
                    <header className="flex flex-row border-b-2 bg-black w-full">
                        <div className="flex flex-row space-y-4 w-full p-4">
                            <div className="flex flex-row justify-between w-full">
                                <div className="text-start">
                                    
                                    <div className="text-white" id="title-column">
                                    <ul className="mt-2 mb-2">
                                        <li className="px-2 mt-1">
                                            <h1 className="text-2xl text-blue-400 font-extrabold">{profile?.first_name}</h1>
                                        </li>
                                        <li className="px-2 mt-1">
                                            <h1 className="text-xl font-bold text-slate-200">{profile?.job_title}</h1>
                                        </li>
                                        </ul>

                                    </div>
                                    <div className="text-white pt-10" id="icon-column">
                                ...
                                <div className="text-start">
                                    <ul className="mt-2 mb-2 text-white">
                                        {/* <li className="px-2 mt-1">
                                        ...
                                        <li className="px-2 mt-1"><strong className="mr-1">Phone </strong>
                                            <a href="tel:+821023456789" className="block text-sky-400  opacity-100 font-bold">{profile.phone}</a>
                                        </li>
                                        <li className="px-2 mt-1"><strong className="mr-1">E-mail </strong>
                                            <a href="mailto:" className="block  text-sky-400 font-bold">{profile.email}</a>
                                        </li>
                                        <li className="px-2 mt-1"><strong className="mr-1">Location</strong>
                                        <span className="block  text-sky-400 font-bold">{profile.address}</span>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div className="w-full p-4 bg-gray-200">
                        <section>
                            <h2 className="text-md text-left border-b-2 font-bold">About</h2>
                            ...
                            <ul className="mt-1">
                                {experience.map((experience, k ) => {
                                    return(
                                        ...
                                        <p className="text-sm text-left">{experience.description}</p>
                                    </li> 
                                    )
                                })}
                                {/* <li className="py-2">
            ...
            <div className="w-1/3 border-l-2 bg-gray-300 opacity-100 p-1">
             ...
             <div className="jsutify-start items-start w-full">

             <div className="flex flex-col justify-center items-center w-full mb-10">
                 <div className="text-left border-b-2 w-full pl-6 gap-x-2">
                     <strong className="text-lg text-white font-bold">Skills</strong>
                 </div>
...
export default TemplateBasic_1;