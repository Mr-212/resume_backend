 ...
 function AddExperienceComponent( {index, experience}: any ) {
    ...
    return(
        ...
        <div className="">
            ...
            <div className={"grid grid-flow-row items-center justify-center shadow-md bg-white p-10 gap-x-6 gap-y-6 " + hidden}>   
                ...
                <div className="flex flex-row w-full">
                    ...
                    <div className="flex flex-row items-center justify-between p-1 w-full">
                        <div className="flex flex-col  justify-center items-start">
                                ...
                                <input type="number" min={"1950"} max={"2300"} className="h-8 pl-1 block  text-black focus:outline-none border-b-2 "  {...register('start_date', {required: false, maxLength:50})} placeholder="" name="start_date"></input>
                                
                        </div>
                        <div className={"flex flex-col justify-center items-start"}>
                                    <label className="block text-sm text-gray-400 pl-1 font-bold">End</label>
                                    <input type="number" min={"1950"} max={"2300"} className="h-8 pl-1 block text-black focus:outline-none border-b-2 disabled"  {...register('end_date', {required: false, maxLength:50})} name="end_date"></input>

                        </div>
                        <div className="flex flex-col justify-center items-center gap-y-4">
                                    <label className="block text-sm text-gray-400 pl-1 font-bold">Current?</label>
                                    <input type="checkbox"  className="block h-4 lock  text-black focus:outline-none border-b-2 "   {...register('is_cuurent_working', {required: false, maxLength:50})} name="is_current_working"></input>
                        </div>
                </div>
                </div>
